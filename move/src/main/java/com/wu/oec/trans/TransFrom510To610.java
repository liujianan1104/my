...
import com.dinfo.model.onto.bean.*;
import com.dinfo.model.onto.dto.*;
...
import com.dinfo.oec.core.model.bean.*;
import com.wu.oec.utils.ModelXmlUtilsOEC610;
...
public class TransFrom510To610 implements ModelVersionTransInter {
    ...
    public void save(String inFilePath, String outPath) throws IOException, ClassNotFoundException {
        ...
        Map<String, Long> keyMap = rebuidId2(oecProjectModelBean);
        ...
        // c分类资源获取及转换
        CclassifyResource cclassifyResource = (CclassifyResource) resultMap
                .get(CclassifyResource.class);
        ...
        // 信息抽取资源获取及转换
        ExtractResource extractResource = (ExtractResource) resultMap.get(ExtractResource.class);
        if (cclassifyResource != null) {
            Map<String, List<ExtractNode>> rootNodeListMap = extractResource.getRootNodeList();
            if (rootNodeListMap != null) {
                for (Map.Entry<String, List<ExtractNode>> entry : rootNodeListMap.entrySet()) {
                    ModelXmlUtilsOEC610.createExOntologyTree(ontology, entry.getValue());
                }
            }
        } else {
        ...
        // s分类资源获
        SclassifyResource sclassifyResource = (SclassifyResource) resultMap
                .get(SclassifyResource.class);
        if (sclassifyResource != null) {
            ...
            if (root_Level_Nodes != null) {
                for (Map.Entry<Long, Map<Integer, List<SclassifyNode>>> entry : root_Level_Nodes
                        .entrySet()) {
        ...
        // 多元组
        MultitupleResource multitupleResource = (MultitupleResource) resultMap
                .get(MultitupleResource.class);
    ...
    private Map<String, Long> rebuidId(OecProjectModelBean oecProjectModelBean) {
        ...
        if (oecProjectModelBean.getOecElements() != null) {
            ...
            for (OecElementModelBean oecElementModelBean : oecProjectModelBean.getOecElements()) {
                ...
                oecElementModelBean.setElementParentId(
                        keyMap.containsKey(parentId) ? keyMap.get(parentId).toString() : "0");
                oecElementModelBean
                        .setElementIdPath(getPath(oecElementModelBean.getElementIdPath(), keyMap));
                oecElementModelBean
                        .setElementLevel(oecElementModelBean.getElementIdPath().split("->").length - 1);
                if (oecElementModelBean.getResources() != null) {
                    for (OecElementResourceModelBean oecElementResourceModelBean : oecElementModelBean
                            .getResources()) {
        ...
        if (oecProjectModelBean.getOecConcepts() != null) {
            ...
            for (OecConceptModelBean oecConceptModelBean : oecProjectModelBean.getOecConcepts()) {
                ...
                oecConceptModelBean.setConceptParentId(
                        keyMap.containsKey(parentId) ? keyMap.get(parentId).toString() : "0");
                oecConceptModelBean
                        .setConceptIdPath(getPath(oecConceptModelBean.getConceptIdPath(), keyMap));
                oecConceptModelBean
                        .setConceptLevel(oecConceptModelBean.getConceptIdPath().split("->").length - 1);
                if (oecConceptModelBean.getResources() != null) {
                    for (OecConceptResourceModelBean oecConceptResourceModelBean : oecConceptModelBean
                            .getResources()) {
                ...
                switch (oecOntologyModelBean.getOntoTypeId()) {
                    case 1: {// c分类
                        if (oecOntologyModelBean.getOecCclassifys() != null) {
                            Collections.sort(oecOntologyModelBean.getOecCclassifys(),
                                    new Comparator<OecCclassifyModelBean>() {
                            ...
                            for (OecCclassifyModelBean oecCclassifyModelBean : oecOntologyModelBean
                                    .getOecCclassifys()) {
                                Long id = PrimaryKeyGenerator.getKeya();
                                ...
                                oecCclassifyModelBean.setClasParentId(
                                        keyMap.containsKey(parentId) ? keyMap.get(parentId).toString() : "0");
                                oecCclassifyModelBean
                                        .setClasIdPath(getPath(oecCclassifyModelBean.getClasIdPath(), keyMap));
                                oecCclassifyModelBean
                                        .setClasLevel(oecCclassifyModelBean.getClasIdPath().split("->").length - 1);
                                oecCclassifyModelBean.setSyhResourceExpression(
                                        transSynResExp(oecCclassifyModelBean.getSyhResourceExpression(), keyMap));
                                if (oecCclassifyModelBean.getResources() != null) {
                                    for (OecCclassifyResourceModelBean oecCclassifyResourceModelBean : oecCclassifyModelBean
                                            .getResources()) {
                            ...
                            for (OecCclassifyModelBean oecCclassifyModelBean : oecOntologyModelBean
                                ...
                                if (oecCclassifyModelBean.getResources() != null) {
                                    for (int i = oecCclassifyModelBean.getResources().size() - 1; i >= 0; i--) {
                                        OecCclassifyResourceModelBean resource = oecCclassifyModelBean.getResources()
                                                .get(i);
                    ...
                    case 2: {// s分类
                        if (oecOntologyModelBean.getOecSclassifys() != null) {
                            Collections.sort(oecOntologyModelBean.getOecSclassifys(),
                                    new Comparator<OecSclassifyModelBean>() {
                            ...
                            for (OecSclassifyModelBean oecSclassifyModelBean : oecOntologyModelBean
                                    .getOecSclassifys()) {
                                Long id = PrimaryKeyGenerator.getKeya();
                                ...
                                oecSclassifyModelBean.setClasParentId(
                                        keyMap.containsKey(parentId) ? keyMap.get(parentId).toString() : "0");
                                oecSclassifyModelBean
                                        .setClasIdPath(getPath(oecSclassifyModelBean.getClasIdPath(), keyMap));
                                oecSclassifyModelBean
                                        .setClasLevel(oecSclassifyModelBean.getClasIdPath().split("->").length - 1);
                                if (oecSclassifyModelBean.getCorpuss() != null) {
                                    for (OecSclassifyCorpusModelBean oecSclassifyCorpusModelBean : oecSclassifyModelBean
                                            .getCorpuss()) {
                    ...
                    case 3: {// 信息抽取
                        if (oecOntologyModelBean.getOecExtracts() != null) {
                            Collections.sort(oecOntologyModelBean.getOecExtracts(),
                                    new Comparator<OecExtractModelBean>() {
                            ...
                            for (OecExtractModelBean oecExtractModelBean : oecOntologyModelBean
                                    .getOecExtracts()) {
                                Long id = PrimaryKeyGenerator.getKeya();
                                ...
                                oecExtractModelBean.setExtParentId(
                                        keyMap.containsKey(parentId) ? keyMap.get(parentId).toString() : "0");
                                oecExtractModelBean
                                        .setExtIdPath(getPath(oecExtractModelBean.getExtIdPath(), keyMap));
                                oecExtractModelBean
                                        .setExtLevel(oecExtractModelBean.getExtIdPath().split("->").length - 1);
                            }
                        }
                    }
                    break;
                    case 4: {// 多元组
                        if (oecOntologyModelBean.getOecMultiTuples() != null) {
                            for (OecMultiTupleModelBean oecMultiTupleModelBean : oecOntologyModelBean
                                    .getOecMultiTuples()) {
                                ...
                                oecMultiTupleModelBean.setSyhResourceExpression(
                                        transSynResExp(oecMultiTupleModelBean.getSyhResourceExpression(), keyMap));
                                // 元组
                                if (oecMultiTupleModelBean.getOecTuples() != null) {
                                    for (OecTupleModelBean oecTupleModelBean : oecMultiTupleModelBean
                                            .getOecTuples()) {
                                        ...
                                        if (oecTupleModelBean.getTupMembers() != null) {
                                            for (OecTupleMemberModelBean oecTupleMemberModelBean : oecTupleModelBean
                                                ...
                                                oecTupleMemberModelBean.setEcnId(
                                                        keyMap.containsKey(ecnId) ? keyMap.get(ecnId).toString()
                                                                : PrimaryKeyGenerator.getKeya().toString());
                                            }
                                        }
                                    }
                                }
                                ...
                                if (oecMultiTupleModelBean.getMemRelates() != null) {
                                    for (int i = oecMultiTupleModelBean.getMemRelates().size() - 1; i >= 0; i--) {
                                        OecTupleMemberRelateModelBean relate = oecMultiTupleModelBean.getMemRelates()
                                                .get(i);
                                        if (!keyMap.containsKey(relate.getOriginTupMemId()) || !keyMap
                                                .containsKey(relate.getTargetTupMemId())) {
     ...
     * 检查并转换c分类表达式
     */
    private boolean checkCclassifyExpressionValid(
            OecCclassifyResourceModelBean oecCclassifyResourceModelBean, Map<String, Long> keyMap) {
        ...
        if (resource.contains("@")) {
            ...
            for (int i = 0; i < position.size(); i++) {
                if (i % 2 == 0) {
                    resource += resource.substring(0, position.get(i)) + "[" + resource
                            .substring(position.get(i) + 1);
                } else {
                    resource += resource.substring(0, position.get(i)) + "]" + resource
                            .substring(position.get(i) + 1);
                }
        ...
        if (oecCclassifyResourceModelBean.getEcidExpression().contains("&")) {
            ...
            oecCclassifyResourceModelBean
                    .setEcnameExpression(
                            oecCclassifyResourceModelBean.getEcnameExpression().replaceAll("&", ""));
        }
    ...
    /**
     * 转换句式分析表达式 SSTP:DNO;FLG:1;NODE:5Ps19mFj$SSTP:SNO;FLG:1;NODE:qdUZsXoq$SSTP:SCOM;FLG:1;NODE:5Trmwjta$SSTP:WCOM;FLG:1;NODE:7FTWnk6k
     */
     ...
     * 填充要素、概念值
     */
    private void initBaesResource(BaseResource baseResource,
        ...
        for (Entry<String, List<OecElementModelBean>> entry : rootElementBeanMap.entrySet()) {
            ...
            for (OecElementModelBean oecElementModelBean : elementModelBeans) {
                elementNodes
                        .add(transOecElementModelBeanToElementNode(oecElementModelBean, entry.getKey()));
            }
        ...
        for (Entry<String, List<OecConceptModelBean>> entry : rootConceptBeanMap.entrySet()) {
            ...
            for (OecConceptModelBean oecConceptModelBean : conceptModelBeans) {
                conceptNodes
                        .add(transOecConceptModelBeanToConceptNode(oecConceptModelBean, entry.getKey()));
            }
    ...
    private ElementNode transOecElementModelBeanToElementNode(OecElementModelBean oecElementModelBean,
        ...
        elementNode.setNote(
                oecElementModelBean.getDescription() == null ? "" : oecElementModelBean.getDescription());
    ...
    private ConceptNode transOecConceptModelBeanToConceptNode(OecConceptModelBean oecConceptModelBean,
        ...
        conceptNode.setNote(
                oecConceptModelBean.getDescription() == null ? "" : oecConceptModelBean.getDescription());
    ...
    private void initCclassifyResource(CclassifyResource cclassifyResource,
                                       OecProjectModelBean oecProjectModelBean) {
        // C分类
        ...
        for (Entry<String, List<OecCclassifyModelBean>> entry : rootClassifyModelBeanMap.entrySet()) {
            ...
            for (OecCclassifyModelBean oecCclassifyModelBean : cclassifyModelBeans) {
                cclassifyNodes
                        .add(transOecCclassifyModelBeanToCclassifyNode(oecCclassifyModelBean, entry.getKey()));
            }
     ...
     */
    private CclassifyNode transOecCclassifyModelBeanToCclassifyNode(
            OecCclassifyModelBean oecCclassifyModelBean,
            String topTreeId) {
        ...
        cclassifyNode
                .setNote(oecCclassifyModelBean.getDescription() == null ? ""
                        : oecCclassifyModelBean.getDescription());
        ...
        if (oecCclassifyModelBean.getSyhType() == null){
            cclassifyNode.setSyn_flg(0);
        }else{
        ...
        for (OecCclassifyResourceModelBean oecCclassifyResourceModelBean : oecCclassifyModelBean
            ...
            cclassifyExpression
                    .setLanguageId(getLangueId("" + oecCclassifyResourceModelBean.getLangueId()));
    ...
    // -------------------s分类-------------------------------
    private void initSclassifyResource(SclassifyResource sclassifyResource,
                                       OecProjectModelBean oecProjectModelBean) {
        //s分类
        ...
        for (OecOntologyModelBean oecOntologyModelBean : oecOntologys) {
            if (oecOntologyModelBean.getOntoTypeId().equals(2)) {// s分类
                List<OecSclassifyModelBean> oecSclassifyModelBeans = oecOntologyModelBean
                        .getOecSclassifys();
        ...
        for (Entry<String, List<OecSclassifyModelBean>> entry : rootSclassifyModelBeanMap.entrySet()) {
            for (OecSclassifyModelBean oecSclassifyModelBean : entry.getValue()) {
                SclassifyNode sclassifyNode = transOecSclassifyModelBeanToSclassifyNode(
                        oecSclassifyModelBean, entry.getKey());
                if (!rootLevelNodes.containsKey(sclassifyNode.getTop_tree_id())) {
                    rootLevelNodes
                            .put(sclassifyNode.getTop_tree_id(), new HashMap<Integer, List<SclassifyNode>>());
                }
                Map<Integer, List<SclassifyNode>> treeNodeMap = rootLevelNodes
                        .get(sclassifyNode.getTop_tree_id());
    ...
    private SclassifyNode transOecSclassifyModelBeanToSclassifyNode(
            OecSclassifyModelBean oecSclassifyModelBean,
            String topTreeId) {
        ...
        sclassifyNode.setNote(oecSclassifyModelBean.getDescription() == null ? ""
                : oecSclassifyModelBean.getDescription());
    ...
    // -------------------信息抽取------------------------------
    private void initExtractResource(ExtractResource extractResource,
                                     OecProjectModelBean oecProjectModelBean) {
        // 信息抽取
        ...
        for (Entry<String, List<OecExtractModelBean>> entry : rootExtractModelBeanMap.entrySet()) {
            ...
            for (OecExtractModelBean oecExtractModelBean : oecExtractModelBeans) {
                extractNodes
                        .add(transOecExtractModelBeanToExtractNode(oecExtractModelBean, entry.getKey()));
            }
    ...
    private ExtractNode transOecExtractModelBeanToExtractNode(OecExtractModelBean oecExtractModelBean,
        ...
        extractNode.setNote(
                oecExtractModelBean.getDescription() == null ? "" : oecExtractModelBean.getDescription());
        extractNode.setTopTreeId(topTreeId);
        List<ExtractInfo> extractInfos = new ArrayList<ExtractInfo>();
        for (OecExtractResourceModelBean oecExtractResourceModelBean : oecExtractModelBean
                .getResources()) {
            ExtractInfo extractInfo = new ExtractInfo();
            extractInfo.setIdExp(oecExtractResourceModelBean.getEcidExpression());
            extractInfo.setNameExp(oecExtractResourceModelBean.getEcnameExpression());
            ...
            extractInfo.setSplitFlg(0);
            extractInfo.setSplitSymbol("");
            extractInfo.setMatchedInfo(null);
            extractInfos.add(extractInfo);
        }
        ...
        for (OecOntologyModelBean oecOntologyModelBean : oecOntologys) {
            if (oecOntologyModelBean.getOntoTypeId().equals(4)) {// 多元组
                ...
                for (OecMultiTupleModelBean oecMultiTupleModelBean : oecMultiTuples) {
                    transOecMultiTupleModelBeanToMultitupleResource(oecMultiTupleModelBean,
                            multitupleResource);
                }
            }
        }
    ...
    private void transOecMultiTupleModelBeanToMultitupleResource(
            OecMultiTupleModelBean oecMultiTupleModelBean,
        ...
        multiTupEntity.setNote(
                oecMultiTupleModelBean.getDescription() == null ? ""
                        : oecMultiTupleModelBean.getDescription());
        ...
        for (OecTupleMemberRelateModelBean oecTupleMemberRelateModelBean : oecMultiTupleModelBean
                .getMemRelates()) {
            TupMemRelEntity tupMemRelEntity = new TupMemRelEntity();
            tupMemRelEntity.setID(null);
            tupMemRelEntity
                    .setOriginTupMemId(Long.parseLong(oecTupleMemberRelateModelBean.getOriginTupMemId()));
            tupMemRelEntity
                    .setTargetTupMemId(Long.parseLong(oecTupleMemberRelateModelBean.getTargetTupMemId()));
    ...
    //  为了信息抽取提供的方法
    private Map<String, Long> rebuidId2(OecProjectModelBean oecProjectModelBean) {
        Map<String, Long> keyMap = new HashMap<String, Long>();
        // 要素
        if (oecProjectModelBean.getOecElements() != null) {
            Collections.sort(oecProjectModelBean.getOecElements(), new Comparator<OecElementModelBean>() {
            ...
            for (OecElementModelBean oecElementModelBean : oecProjectModelBean.getOecElements()) {
                if(oecElementModelBean.getElementName() == null || oecElementModelBean.getElementName() == "" || oecElementModelBean.getElementName() == "null"){
                    System.out.println();
                }
                Long id = PrimaryKeyGenerator.getKeya();
                keyMap.put(oecElementModelBean.getElementId(), id);
        ...
        if (oecProjectModelBean.getOecConcepts() != null) {
            ...
            for (OecConceptModelBean oecConceptModelBean : oecProjectModelBean.getOecConcepts()) {
                if(oecConceptModelBean.getConceptName() == null || oecConceptModelBean.getConceptName() == "" || oecConceptModelBean.getConceptName() == "null"){
                    System.out.println();
                }
                Long id = PrimaryKeyGenerator.getKeya();
                keyMap.put(oecConceptModelBean.getConceptId(), id);
                ...
                switch (oecOntologyModelBean.getOntoTypeId()) {
                    case 3: {// 信息抽取
                        ...
                        if (oecOntologyModelBean.getOecExtracts() != null) {
                            ...
                            for (OecExtractModelBean oecExtractModelBean : oecOntologyModelBean
                                    .getOecExtracts()) {
                                System.out.println(oecExtractModelBean.getExtName());
                                if(oecExtractModelBean.getExtName() == null || oecExtractModelBean.getExtName() == "" || oecExtractModelBean.getExtName() == "null"){
                                    System.out.println();
                                }
                                Long id = PrimaryKeyGenerator.getKeya();
                                keyMap.put(oecExtractModelBean.getExtId(), id);
                                ...
                                List<OecExtractResourceModelBean> resources = oecExtractModelBean.getResources();
                                if (resources != null) {
                                    for (OecExtractResourceModelBean oecExtractResourceModelBean : resources) {
                                        String ecidExpression = oecExtractResourceModelBean.getEcidExpression();
                                        if (ecidExpression.contains("c_")) {
//                                            System.out.println("替换c_标签");
//                                            System.out.println("转换前表达式： " + ecidExpression);
                                            String[] all = ecidExpression.split("c_");
                                            for (int i = 1; i < all.length; i++) {
                                                String temp = all[i].substring(0, 8);
//                                                System.out.println("原有表达式id:" + temp);
                                                if (keyMap.containsKey(temp)) {
                                                    String rid = keyMap.get(temp).toString();
//                                                    System.out.println("对应表达式id:" + rid);

                                                    ecidExpression = ecidExpression.replace(temp, rid);
                                                }
                                            }
//                                            System.out.println("转换后表达式： " + ecidExpression);
//                                            System.out.println("================================");
                                            oecExtractResourceModelBean.setEcidExpression(ecidExpression);
                                        }
                                        //  增加对本体中要素的替换
                                        if(ecidExpression.contains("e_")){
//                                            System.out.println("替换e_标签");
//                                            System.out.println("转换前表达式： " + ecidExpression);
                                            String[] all = ecidExpression.split("e_");
                                            for (int i = 1; i < all.length; i++) {
                                                String temp = all[i].substring(0, 8);
//                                                System.out.println("原有表达式id:" + temp);
                                                if (keyMap.containsKey(temp)) {
...
//                        System.out.println("C分类模型替换");
                        if (oecOntologyModelBean.getOecCclassifys() != null) {
                            ...
                            for (OecCclassifyModelBean oecCclassifyModelBean : oecOntologyModelBean
                                    .getOecCclassifys()) {
                                System.out.println(oecCclassifyModelBean.getClasName());
                                if(oecCclassifyModelBean.getClasName() == null || oecCclassifyModelBean.getClasName() == "" ||  oecCclassifyModelBean.getClasName() == "null"){
                                    System.out.println();
                                }
                                Long id = PrimaryKeyGenerator.getKeya();
                                keyMap.put(oecCclassifyModelBean.getClasId(), id);
                                ...
                                List<OecCclassifyResourceModelBean> resources = oecCclassifyModelBean.getResources();
                                if (resources != null) {
                                    for (OecCclassifyResourceModelBean oecCclassifyResourceModelBean : resources) {
                                        String ecidExpression = oecCclassifyResourceModelBean.getEcidExpression();
                                        if (ecidExpression.contains("c_")) {
//                                            System.out.println("替换c_标签");
//                                            System.out.println("转换前表达式： " + ecidExpression);
                                            String[] all = ecidExpression.split("c_");
...
//                                            System.out.println("转换后表达式： " + ecidExpression);
//                                            System.out.println("================================");
                                            oecCclassifyResourceModelBean.setEcidExpression(ecidExpression);
                                        }
                                        //  增加对本体中要素的替换
                                        if(ecidExpression.contains("e_")){
//                                            System.out.println("替换e_标签");
